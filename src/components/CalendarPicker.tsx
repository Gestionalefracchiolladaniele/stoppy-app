...
const styles = StyleSheet.create({
  ...
  navBtn: {
    width: 28, height: 28,
    borderRadius: 8,
    backgroundColor: 'rgba(92,62,156,0.08)',
    alignItems: 'center',
    justifyContent: 'center',
  },
  navArrow: { fontSize: 18, color: '#5C3E9C', fontWeight: '700', lineHeight: 20 },
  navTitle: { fontSize: 13, fontWeight: '700', color: '#2B1A52' },
  row: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    marginBottom: 1,
  ...
  dayCellSel: { backgroundColor: '#5C3E9C' },
  dayCellBet: { backgroundColor: 'rgba(92,62,156,0.1)', borderRadius: 0 },
  dayText: { fontSize: 12, fontWeight: '500', color: '#2B1A52' },
  dayTextToday: { color: '#5C3E9C', fontWeight: '700' },
  dayTextSel: { color: 'white', fontWeight: '700' },
  dayTextFuture: { color: 'rgba(43,26,82,0.22)' },
  selLabel: {
    textAlign: 'center',
    fontSize: 11,
    fontWeight: '600',
  ...
  btnCancel: {
    ...
    backgroundColor: 'rgba(92,62,156,0.07)',
    alignItems: 'center',
  },
  btnCancelText: { fontSize: 13, fontWeight: '600', color: 'rgba(43,26,82,0.55)' },
  btnApply: {
    flex: 1, paddingVertical: 9, borderRadius: 12,
